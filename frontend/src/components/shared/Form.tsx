...
export default function Form() {
  ...
  // Trigger IPFS upload only when a file is selected
  // This avoids calling the upload on every render
  // and ensures the URL is set once per selection
  // eslint-disable-next-line react-hooks/exhaustive-deps
  // useEffect would be ideal, but keep callback-driven flow consistent
  // Invoke explicitly when file is selected
  if (selectedFile && !url) {
    // fire-and-forget; internal function handles errors
    void getImage();
  }
